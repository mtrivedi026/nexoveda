...
async function runSeed() {
  ...
  const users = [
    ...
    },
    {
      ...
      password: hashedPassword,
      loyaltyPoints: 50.00, // Seeds 50 points (value of $5.00 discount)
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString()
    }
  ];
  ...
  const products = [
    {
      ...
      rating: 4.9,
      reviewCount: 15,
      discountPercent: 10, // 10% off promotion active
  ...
  const orders = [
    {
      ...
      subtotal: 53.98, // Discount applied (29.99 * 2 * 0.9 = 53.98)
      shippingCost: 0, // Free delivery above $50.00
      total: 53.98,
      status: 'pending',
