...
async function syncAgents(dbInstance) {
  try {
    ...
    const smitaData = {
      name: 'Psychological Wellness Specialist',
    ...
    if (anamikaExists) {
      ...
      await dbInstance.User.create({ ...anamikaData });
    ...
    if (harshExists) {
      ...
      await dbInstance.User.create({ ...harshData });
    ...
    if (smitaExists) {
      ...
      await dbInstance.User.create({ ...smitaData });
    ...
    if (adminExists) {
      ...
      await dbInstance.User.create({ ...adminData });
