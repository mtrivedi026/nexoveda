...
Access the staff portal at: https://nexoveda.com/staff`;
  ...
  try {
    ...
    if (smtpUser && smtpPass) {
      ...
      console.warn('⚠️ SMTP_USER and SMTP_PASS environment variables are not configured in .env. Skipping real email alert sending.');
      console.log('Email content that would have been sent:');
      console.log(`To: nexoveda@gmail.com\nSubject: ${emailSubject}\nBody: ${emailText}`);
    }
  } catch (emailErr) {
